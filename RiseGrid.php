		...
		public function _genColumnStr()
		{
			...
			if (is_object($model)) {
				...
				foreach($all as $item => $value) {
					...
					$obj->editable =true;
					$obj->edittype='select';
					$obj->editoptions="{value : 'FE:陈帅哥;IN:张帅哥;TN:李帅哥;AR:MJJ'}";
...
//			$str .= 'colModel:' . $this->_getString($data) . ",\r\n";
		 ...
		 * @param      $field
		 */
		public function _getLabel($model, $field)
		{
			/**@var  ActiveRecord $model */
