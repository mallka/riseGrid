	...
	$.extend(true, jgrid, {
		...
		icons: {
			...
			fontAwesome: {
				...
				sort: {
					common: "fas ",        // common: "",
					asc: "ffas fa-sort-numeric-down",     // asc: "fa-sort-amount-asc",
					desc: "ffas fa-sort-numeric-up"    // desc: "fa-sort-amount-desc"
				},
				gridMinimize: {
                    common: "fa",
		...
		guiStyles: {
			...
			bootstrap4: {
				...
				hTable: "table table-hover table-sm ",
				colHeaders: "",
				states: {
				...
				rowNum: "",
				gridFooter: "table table-hover table-condensed table-bordered",
				// gridFooter: "table table-hover table-sm",
				rowFooter: "",
				gridTitle: "",
				gridError: "alert alert-danger",
				gridErrorText: "sr-only",
